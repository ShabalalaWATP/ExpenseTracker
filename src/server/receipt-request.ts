...
export function receiptRequestBody(
  ...
  return {
    ...
    instructions: [
      ...
      "Return currency GBP only when pounds sterling are evident. Return country GB only when the merchant address, tax details or other printed evidence place the purchase in the United Kingdom; otherwise return UNKNOWN.",
      ...
      "For food receipts: eligible means food, non-alcoholic drink and permitted gratuities or service charges. Include any eligible gratuity in eligible_pence and also report it separately in gratuity_pence. Never apply the £30 allowance as an extraction cap.",
      "Exclude and flag suspected alcohol. Verify the eligible total against eligible line items.",
      "For travel and parking receipts: eligible_pence is the full fare or fee, alcohol checks do not apply, and gratuity_pence is 0 unless a tip is printed.",
